...
def get_current_medications() -> str:
    """
    ...
    return json.dumps(current_medications, default=datetime_converter)


@action(is_consequential=False)
def get_entire_medication_history(start_date: str, end_date: str) -> str:
    """
    ...
    medication_history = fhir_medications_service.get_entire_medication_history(history_start, history_end)
    return json.dumps(medication_history, default=datetime_converter)
...
def get_medication_history_by_rxnorm(rxnorm_code: str) -> str:
    ...
    medication_history = fhir_medications_service.get_medication_history_by_rxnorm(rxnorm_code)
