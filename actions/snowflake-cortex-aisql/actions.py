...
def ai_parse_document(
    ...
    """
    Uploads a file (PDF, PPTX, DOCX, JPEG, JPG, PNG, TIFF, TIF, HTML, TXT) from the chat to a specified Snowflake stage and parses it's content using Cortex AISQL AI_PARSE_DOCUMENT function.
    ...
    Returns:
        Details of the uploaded file, and the json string of the parse_document processing results.
    """
    try:
