...
This action package enables you to upload PDF documents to Snowflake and extract their content using [Snowflake Cortex AISQL](https://docs.snowflake.com/en/user-guide/snowflake-cortex/parse-document). It uses one-shot parsing with no training required, making it easy to extract structured data from PDFs and image files.
