...
class InvoiceLoader:
    def __init__(self, db_path: Optional[Union[str, Path]] = None):
        ...
        try:
            ...
            self.logger.info(f"Database path for reconciliation_ledger set to: {self.db_path}")
    ...
    def _load_invoices_from_setup(self, conn, customer: Dict, invoices: List[Dict], discrepancy_config: Dict):
        ...
        facility_totals = {
            k: DecimalHandler.round_decimal(v)
        ...
        for invoice in sorted_invoices:
            ...
            if facility_type in adjustments:
                ...
                if isinstance(adjustment, dict):
                    if adjustment['condition'] == 'water_service' and invoice['service_type'] == 'Water':
