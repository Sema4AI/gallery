...
class RemittanceFields(BaseModel):
    ...
    @validator(
        "total_payment", "total_invoice_amount", "total_discounts", "total_charges"
    )
...
class ReconciliationResponse(ActionResponse):
    ...
    reconciliation_result: Optional[Union[ReconciliationResult, Dict[str, Any]]] = (
        Field(default=None, description="Reconciliation analysis result")
    )
